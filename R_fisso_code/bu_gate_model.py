...
# Modello intermedio con Basis Unit e Gate
class modello_intermedio(nn.Module):
    def __init__(self, input_dim, n_hidden, n_neurons):
        super().__init__()
        ...
        # Condivido lo stesso parametro di energia tra la Basis Unit e il modello intermedio 
    ...
    def forward(self, X, R):
        ...
        return psi_LCAO + gate_value * correzione 
